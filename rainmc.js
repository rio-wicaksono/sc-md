...
farisofc.sendMessage(m.chat, {
      ...
      title: botname,
      body: ownername,
      thumbnailUrl: 'https://telegra.ph/file/f0f948d211cad0544f322.jpg',
      sourceUrl: ``,
      mediaType: 1,
...
title: `Rain , Mc`,body:`⌜ Bot MD ⌟`,previewType:"PHOTO",thumbnailUrl: thumb,sourceUrl: `${sgc}`,}
...
let nominal = t[1];
        reply(mess.save)
reply(`𝐒𝐘𝐒𝐓𝐄𝐌 𝐒𝐀𝐕𝐄 𝐎𝐓𝐎𝐌𝐀𝐓𝐈𝐒 𝐃𝐎𝐍𝐄✅

𝐊𝐎𝐍𝐓𝐀𝐊 : ${nominal}

𝐉𝐀𝐍𝐆𝐀𝐍 𝐋𝐔𝐏𝐀 𝐒𝐀𝐕𝐄 𝐁𝐀𝐂𝐊 ${namaStore} 𝐘𝐎𝐎`)
}
        break        
        case 'getbio':{
            try {
...
┣⌬ ➟ ${prefix}ᴛᴇʙᴀᴋ ᴋᴀᴛᴀ
┣⌬ ➟ ${prefix}ᴛᴇʙᴀᴋ ʙᴇɴᴅᴇʀᴀ
┣⌬ ➟ ${prefix}ᴛᴇʙᴀᴋ ʙᴇɴᴅᴇʀᴀ2
┣⌬ ➟ ${prefix}ᴛᴇʙᴀᴋ ᴋᴀʙᴜᴘᴀᴛᴇɴ
┣⌬ ➟ ${prefix}ᴛᴇʙᴀᴋ ᴋɪᴍɪᴀ
┣⌬ ➟ ${prefix}ᴛᴇʙᴀᴋ sɪᴀᴘᴀᴋᴀʜᴀᴋᴜ
┣⌬ ➟ ${prefix}ᴛᴇʙᴀᴋ sᴜsᴜɴᴋᴀᴛᴀ
┣⌬ ➟ ${prefix}ᴛᴇʙᴀᴋ ᴛᴇᴋᴀᴛᴇᴋɪ
┣⌬ ➟ ${prefix}ᴍᴀᴛʜ
...
break
        ...
        case "addprem":{
if (!isOwner) return reply(mess.only.owner)
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285601059864`)
...
case "listgroup":{
if (!isOwner) return (`Ngapain ? Khusus Mas ${namaowner} Aja !!`)
let getGroups = await farisofc.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let anu = groups.map((v) => v.id)
let hituet = 0
...
break
case "hidetag": {
if (!isOwner) return reply(`Khusus Mas  Aja`)
if (!isGroup) return reply(mess.only.group)
if (!isBotAdmins) return reply(mess.only.badmin)
...
if (!isOwner) return reply(`Khusus Mas ${namaowner} Aja`)
...
farisofc.sendMessage(m.chat, {
      ...
      title: botname,
      body: ownername,
      thumbnailUrl: 'https://telegra.ph/file/b33d30fb0bacd5fd76648.jpg',
      sourceUrl: ``,
      mediaType: 1,
      renderLargerThumbnail: true
      }
...
case "mc":{
if (!isOwner) return reply('Maaf, command ini hanya untuk pemilik.')
if (!text) return reply("salah contoh .mc 250k by ${namaowner} OFFC")
...
let cpu = "10"
let disk = "0"
let email = username + "@${namaowner}.com"
akunlo = "https://telegra.ph/file/401f71fd68421a96d2fce.jpg" 
if (!u) return
...
farisofc.sendMessage('6281111111111@s.whatsapp.net', { text: util.format(err) })
}
}
